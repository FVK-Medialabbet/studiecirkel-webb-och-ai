# Videobank – bedömda videor

_Information om videorna är senast uppdaterad november 2025._

## Tabell – alla bedömda videor

| # | Titel | Länk | Längd (ca) | Svårighetsgrad | Rekommenderad användning | Med i kursen? |
|---|-------|------|------------|-----------------|--------------------------|---------------|
| 1 | Hur du kopplar källkod till GitHub och aktiverar GitHub Pages för HTML-sidor (på svenska) | https://www.youtube.com/watch?v=3hmz-nMtzTg | ~10–15 min (uppskattning) | Nybörjare | Gemensam genomgång i **modul 1.1**: vi ser videon i korta delar, pausar och gör samma sak själva (repo + första sidan + aktivera GitHub Pages). | Ja – Paket 1, modul 1.1 |
| 2 | Git – En introduktion på svenska (spellista) – Martin Haagen | https://www.youtube.com/playlist?list=PLwh73nXB3whgormDmX_skiiJfHfOa9Jgd | ~1,5 h totalt (7 delar) | Nybörjare–medel | Fördjupning till **modul 1.1** och senare moduler. Rekommenderas som självstudier mellan träffarna för den som vill förstå Git på djupet (grenar, merge, samarbete, push/pull, SSH-nycklar m.m.). | Ja – fördjupning Paket 1 & 2 |
| 3 | HTML och CSS – nybörjarguide på svenska (spellista) | https://youtube.com/playlist?list=PLuc3JXzcNTZSYxj8Q32SIbR7wt7fgi7of | ~1 h totalt (13 delar) | Nybörjare | Huvudresurs i **modul 1.2**. Vi ser delar av spellistan tillsammans i två sittningar på samma träff, med paus för diskussion och övningar i deltagarnas egna HTML/CSS-filer. | Ja – Paket 1, modul 1.2 |
