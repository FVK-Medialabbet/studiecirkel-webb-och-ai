...
### Smakprov – Array.map i 100 sekunder (Fireship)

En kort video som visar hur du kan omvandla listor i JavaScript med `array.map`:

- [JavaScript Array.map in 100 Seconds – Fireship](https://youtu.be/DC471a9qrU4?si=s_ZCwPL8T7ZLFGRl)
---
